var socket = io.connect('http://localhost:3000'); //connect to server
        ...
        socket.on('weight', function(data){
            ...
            if(data.h1 == 'US'||data.h1 =='OT'){
                ...
                document.getElementById('massWeight').style.backgroundColor ="steelblue";
        ...
        socket.on('u81', function(data) {
            ...
            if(data.msgH !=''){
                ...
                document.getElementById('height').style.backgroundColor ="steelblue";
            }
            if(data.msgL !=''){
                ...
                document.getElementById('length').style.backgroundColor ="steelblue";
            }
            if(data.msgW !=''){
                ...
                document.getElementById('width').style.backgroundColor ="steelblue";
            }
            //console.log(data);
        });
        ...
        socket.on('dataVNP', function(data){
            ...
            document.getElementById('vnpostHeight').innerHTML = data.height;
